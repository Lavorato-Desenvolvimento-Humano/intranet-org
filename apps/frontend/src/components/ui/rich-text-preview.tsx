    ...
    <div className="w-full mt-4">
      ...
      {showPreview && (
        <div
          ...
          <div
            className="prose max-w-none break-words prose-img:rounded-lg prose-img:shadow-sm prose-img:max-w-full prose-img:h-auto [&_p]:whitespace-pre-wrap [&_br]:block"
