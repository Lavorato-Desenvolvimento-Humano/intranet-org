...
public interface FileRepository extends JpaRepository<FileEntity, Long>, JpaSpecificationExecutor<FileEntity> {
    ...
    Page<FileEntity> findByOwnerIdAndIsDeletedFalse(Long ownerId, Pageable pageable);

    Page<FileEntity> findByFolderIdAndIsDeletedFalse(Long folderId, Pageable pageable);
