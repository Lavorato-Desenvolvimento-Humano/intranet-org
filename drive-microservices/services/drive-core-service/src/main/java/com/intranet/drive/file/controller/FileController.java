...
public class FileController {
    ...
    @Operation(summary = "Busca avançada", description = "Filtros combinados")
    public ResponseEntity<Page<FileDto>> searchAdvanced(
        ...
        // Nota: A lógica de validação de permissão deve ser aplicada pós-filtro ou
        // injetada na query (mais complexo, mas mais seguro)

        Pageable pageable = PageRequest.of(page, size, Sort.by(Sort.Direction.DESC, "createdAt"));

        Page<FileDto> files = fileService.searchAdvanced(query, type, startDate, endDate, minSize, maxSize, pageable);
